...
from config import CLIENT_ID, REDIRECT_URI, TOKEN_URL, GRANT_TYPE, \
    SERVER_URL, ACCESS_TOKEN_INFO_URL, LOGOUT_URL, TARGET_ID_TYPE, RESPONSE_TYPE, \
    AUTHORIZE_URL, REFRESH_URL, REFRESH_GRANT_TYPE, USER_INFO_URL, SERVICE_TERM
...
async def root():
    return RedirectResponse(
        url=f"{AUTHORIZE_URL}?client_id={CLIENT_ID}&redirect_uri={REDIRECT_URI}&response_type={RESPONSE_TYPE}&service_terms=${SERVICE_TERM}",
    )
